  ...
  <card>
    ...
    <div class="row">
      <div class="col-md-6 pr-md-1 text-left">
        <base-input label="Room Number" placeholder="Room Number" v-model="model.RoomNumber">
        </base-input>
      </div>
      <div class="col-md-6 pl-md-1 text-left">
        <base-input label="Room type" placeholder="Room type" v-model="model.RoomType">
        </base-input>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 pl-md-1 text-left">
        <base-input label="Floor" placeholder="Floor Name" v-model="model.Floor" >
        </base-input>
      </div>
    </div>
